...
var indexFirstPart = getRandomIndex(0, firstParts.length-1);
var indexSecondPart = getRandomIndex(0, secondParts.length-1);
var indexThirdPart = getRandomIndex(0, thirdParts.length-1);

console.log(firstParts[indexFirstPart] + secondParts[indexSecondPart] + thirdParts[indexThirdPart]);